      ...
      <div class='card shadow mb-4' style='margin-bottom: 50px' >
         ...
         <div class='card-body'>
            ...
            <div class="form-group">
               <label for="varchar">Iditem <?php echo $validation->getError('iditem') ?></label>
               <input type="text" class="form-control" name="iditem" id="iditem" placeholder="Iditem" value="<?php echo $iditem; ?>" />
            </div>
            <div class="form-group">
               <label for="int">Id Categoria <?php echo $validation->getError('id_categoria') ?></label>
            ...
            <div class="form-group">
               <label for="timestamp">Created At <?php echo $validation->getError('created_at') ?></label>
               <input type="text" class="form-control" name="created_at" id="created_at" placeholder="Created At" value="<?php echo $created_at; ?>" />
            </div>
            <div class="form-group">
               <label for="timestamp">Updated At <?php echo $validation->getError('updated_at') ?></label>
               <input type="text" class="form-control" name="updated_at" id="updated_at" placeholder="Updated At" value="<?php echo $updated_at; ?>" />
            </div>
            <div class="form-group">
               <label for="timestamp">Deleted At <?php echo $validation->getError('deleted_at') ?></label>
